...
(function() {
    ...
    class CryptoMarqueeWidget {
        ...
        render() {
            ...
            this.element.innerHTML = '<div class="cwn-marquee-widget' + themeClass + '">' +
        ...
        processData(rawData) {
            ...
            return rawData
                .filter(function(token) {
                    return !blacklistedSymbols.includes(token.symbol && token.symbol.toUpperCase());
                })
                .map(function(token) {
                    return {
                        symbol: token.symbol,
                        ...
                        icon: token.icon || 'https://cdn.jsdelivr.net/gh/spothq/cryptocurrency-icons/32/color/' + (token.symbol && token.symbol.toLowerCase()) + '.png'
                    };
                });
        }
        ...
        updateContent() {
            ...
            const items = this.cryptoData.map(this.createCryptoItem.bind(this));
            ...
            marqueeContent.innerHTML = '<div class="cwn-marquee-items">' + itemsHTML + '</div>' +
        ...
        createPoweredByItem() {
            return '<a href="https://www.cryptowatchnews.com" class="cwn-powered-by" target="_blank" rel="noopener">' +
                '<img src="https://www.cryptowatchnews.com/favicon-32x32.png" alt="CryptoWatchNews" class="cwn-powered-by-icon" onerror="this.style.display=\'none\'"/>' +
                '<span>Powered by CryptoWatchNews</span></a>';
        }
